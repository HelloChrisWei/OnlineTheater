...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\JavaPrograms\\guns\\guns-cinema\\src\\main\\java");//这里写你自己的java目录
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/mtime?characterEncoding=utf8");
        ...
        strategy.setInclude(new String[]{"mtime_brand_dict_t","mtime_area_dict_t","mtime_hall_dict_t","mtime_cinema_t","mtime_field_t","mtime_hall_film_info_t"});
...
//        pc.setController("com.stylefeng.guns.rest.modular.cinema.controller");
