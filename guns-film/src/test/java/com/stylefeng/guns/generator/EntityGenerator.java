...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\JavaPrograms\\guns\\guns-film\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"mtime_banner_t","mtime_cat_dict_t","mtime_year_dict_t","mtime_film_t","mtime_film_info_t","mtime_actor_t"});
//        strategy.setInclude(new String[]{"mtime_source_dict_t"});
        ...
        pc.setController("com.stylefeng.guns.rest.modular.film.controller");    //本项目没用，生成之后删掉
